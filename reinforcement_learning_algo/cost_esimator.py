...
from loma_copy import allocate_memory_for_tl_order, create_loop_objects, perform_greedy_mapping, get_utilization, \
...
def get_temporal_loop_estimation(temporal_mapping_ordering, input_settings, spatial_loop_comb, mem_scheme, layer,
                                 mac_costs, ):
    """
    ...
    allocated_order = allocate_memory_for_tl_order(temporal_mapping_ordering, spatial_loop, layer_origin,
                                                   input_settings,
                                                   mem_scheme.nodes)
