...
def mem_scheme_su_evaluate(input_settings, layer_, im2col_layer, layer_index, layer_info, mem_scheme, mem_scheme_index,
    ...
    while (redo_flag and iterate_time < mem_ut_iter_max and not (loma_search_engine or RL_search_engine or meta_loma_search_engine)) or (redo_flag and input_settings.fixed_temporal_mapping):
